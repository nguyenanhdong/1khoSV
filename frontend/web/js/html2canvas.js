...
(function (global, factory) {
     ...
     ***************************************************************************** */
     ...
     var BREAK_MANDATORY = '!';
     var BREAK_NOT_ALLOWED$1 = 'Ă—';
     var BREAK_ALLOWED$1 = 'Ă·';
     ...
     var codePointsToCharacterClasses = function (codePoints, lineBreak) {
         ...
         codePoints.forEach(function (codePoint, index) {
             ...
             if (['normal', 'auto', 'loose'].indexOf(lineBreak) !== -1) {
                 // U+2010, â€“ U+2013, ă€œ U+301C, ă‚  U+30A0
     ...
     var JAPANESE_NEGATIVE = 'ăƒă‚¤ăƒă‚¹';
     var KOREAN_NEGATIVE = 'ë§ˆ́´ë„ˆ́¤';
     var createCounterText = function (value, type, appendSuffix) {
         var defaultSuffix = appendSuffix ? '. ' : '';
         var cjkSuffix = appendSuffix ? 'ă€' : '';
         ...
         switch (type) {
             ...
             case LIST_STYLE_TYPE.CJK_DECIMAL:
                 return createCounterStyleFromSymbols(value, 'ă€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', cjkSuffix);
             ...
             case LIST_STYLE_TYPE.CJK_HEAVENLY_STEM:
                 return createCounterStyleFromSymbols(value, 'ç”²ä¹™ä¸™ä¸æˆå·±åºè¾›å£¬ç™¸', cjkSuffix);
             ...
             case LIST_STYLE_TYPE.TRAD_CHINESE_FORMAL:
                 return createCJKCounter(value, 'é›¶å£¹è²³åƒè‚†ä¼é™¸æŸ’æŒç–', CHINESE_FORMAL_MULTIPLIERS, 'è² ', cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
             ...
             case LIST_STYLE_TYPE.SIMP_CHINESE_FORMAL:
                 return createCJKCounter(value, 'é›¶å£¹è´°åè‚†ä¼é™†æŸ’æŒç–', CHINESE_FORMAL_MULTIPLIERS, 'è´Ÿ', cjkSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS | CJK_HUNDRED_COEFFICIENTS);
             case LIST_STYLE_TYPE.JAPANESE_INFORMAL:
                 return createCJKCounter(value, 'ă€‡ä¸€äºŒä¸‰å››äº”å…­ä¸ƒå…«ä¹', 'åç™¾åƒä¸‡', JAPANESE_NEGATIVE, cjkSuffix, 0);
             ...
             case LIST_STYLE_TYPE.KOREAN_HANGUL_FORMAL:
                 return createCJKCounter(value, '́˜́¼́´́‚¼́‚¬́˜¤́œ¡́¹ íŒ”êµ¬', '́‹­ë°±́²œë§Œ', KOREAN_NEGATIVE, koreanSuffix, CJK_ZEROS | CJK_TEN_COEFFICIENTS | CJK_TEN_HIGH_COEFFICIENTS);
             ...
             case LIST_STYLE_TYPE.HIRAGANA:
                 return createCounterStyleFromSymbols(value, 'ă‚ă„ă†ăˆăă‹ăăă‘ă“ă•ă—ă™ă›ăăŸă¡ă¤ă¦ă¨ăªă«ă¬ă­ă®ă¯ă²ăµă¸ă»ă¾ă¿ă‚€ă‚ă‚‚ă‚„ă‚†ă‚ˆă‚‰ă‚ă‚‹ă‚Œă‚ă‚ă‚ă‚‘ă‚’ă‚“');
             case LIST_STYLE_TYPE.HIRAGANA_IROHA:
                 return createCounterStyleFromSymbols(value, 'ă„ă‚ă¯ă«ă»ă¸ă¨ă¡ă‚ă¬ă‚‹ă‚’ă‚ă‹ă‚ˆăŸă‚Œăă¤ă­ăªă‚‰ă‚€ă†ă‚ă®ăăă‚„ă¾ă‘ăµă“ăˆă¦ă‚ă•ăă‚†ă‚ă¿ă—ă‚‘ă²ă‚‚ă›ă™');
             case LIST_STYLE_TYPE.KANNADA:
                 return createCounterStyleFromRange(value, 0xce6, 0xcef, true, defaultSuffix);
             case LIST_STYLE_TYPE.KATAKANA:
                 return createCounterStyleFromSymbols(value, 'ă‚¢ă‚¤ă‚¦ă‚¨ă‚ªă‚«ă‚­ă‚¯ă‚±ă‚³ă‚µă‚·ă‚¹ă‚»ă‚½ă‚¿ăƒăƒ„ăƒ†ăƒˆăƒăƒ‹ăƒŒăƒăƒăƒăƒ’ăƒ•ăƒ˜ăƒ›ăƒăƒŸăƒ ăƒ¡ăƒ¢ăƒ¤ăƒ¦ăƒ¨ăƒ©ăƒªăƒ«ăƒ¬ăƒ­ăƒ¯ăƒ°ăƒ±ăƒ²ăƒ³', cjkSuffix);
             case LIST_STYLE_TYPE.KATAKANA_IROHA:
                 return createCounterStyleFromSymbols(value, 'ă‚¤ăƒ­ăƒăƒ‹ăƒ›ăƒ˜ăƒˆăƒăƒªăƒŒăƒ«ăƒ²ăƒ¯ă‚«ăƒ¨ă‚¿ăƒ¬ă‚½ăƒ„ăƒăƒăƒ©ăƒ ă‚¦ăƒ°ăƒă‚ªă‚¯ăƒ¤ăƒă‚±ăƒ•ă‚³ă‚¨ăƒ†ă‚¢ă‚µă‚­ăƒ¦ăƒ¡ăƒŸă‚·ăƒ±ăƒ’ăƒ¢ă‚»ă‚¹', cjkSuffix);
