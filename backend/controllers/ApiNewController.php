...
class ApiNewController extends Controller
{
     ...
     */
    public static function LoginWithPhone(){
        try{
     ...
     */
    public static function LoginWithSocialNew(){
        try{
            $params = self::getParamsRequest([
                'social_id' => [
                    'type' => self::TYPE_STRING,
     ...
     * API ví tích điểm
     */
    public static function WalletPoint(){
     ...
     */
    public static function VoucherDetail(){
        try {
            $params = self::getParamsRequest([
                'id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function AgentHome(){
        try {
            $params = self::getParamsRequest([
                'id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function DetailNotify(){
        try {
            $params = self::getParamsRequest([
                'notify_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function WarrantyPolicy(){
        try {
     ...
     */
    public static function ViewMoreReview(){
        try{
            $params = self::getParamsRequest([
                'product_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function ToggleFollowAgent(){
        try{
            $params = self::getParamsRequest([
                'agent' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function ToggleFavouriteProduct(){
        try{
            $params = self::getParamsRequest([
                'product_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function ListVoucherByOrder(){
        try{
            $params = self::getParamsRequest([
                'product_combination' => [
                    'type' => self::TYPE_ARRAY,
     ...
     */
    public static function ListProductFavourite(){
        try{
            $params = self::getParamsRequest([
                'limit'    => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function ListProductView(){
        try{
            $params = self::getParamsRequest([
                'limit'    => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function CreateReviewProduct(){
        try {
            $params = self::getParamsRequest([
                'order_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function DeleteMediaUpload(){
        try {
            $params = self::getParamsRequest([
                'media_token' => [
                    'type' => self::TYPE_STRING,
     ...
     */
    public static function ListReviewOfUser(){
        try {
            $params = self::getParamsRequest([
                'type_review' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function RefundOrderInfo(){
        try {
            $params = self::getParamsRequest([
                'order_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function RequestRefundOrder(){
        try {
            $params = self::getParamsRequest([
                'order_id' => [
                    'type' => self::TYPE_INT,
     ...
     */
    public static function AdvertisementFormInfo(){
        try {
     ...
     */
    public static function CreateAdvertisement(){
        try {
            $params = self::getParamsRequest([
                'type_adv' => [
                    'type' => self::TYPE_INT,
