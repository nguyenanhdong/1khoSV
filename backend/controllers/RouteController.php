...
class RouteController extends Controller
{
    ...
    public function actionRefresh()
    {
        ...
        // Yii::$app->getResponse()->format = 'json';
        // return $model->getRoutes();
        $listRoute = $model->getRoutes();
        // echo '<pre>';
        // var_dump($listRoute);die;
        if( isset($listRoute['available']) && !empty($listRoute['available']) )
            $model->addNew($listRoute['available']);
