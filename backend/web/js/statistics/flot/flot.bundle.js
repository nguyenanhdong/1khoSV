        ...
        function setupTickGeneration(axis) {
            ...
            if (!axis.tickGenerator) {
				...
				axis.tickFormatter = function (value, axis) {
                    ...
                    console.log(axis.tickDecimals,formatted);
...
(function ($) {
	...
	// for CurvedLines plugin we need to read data from different place
        ...
        */
        ...
        // console.log(item.series.xaxis.tickFormatter);
        if (typeof item.series.xaxis.tickFormatter !== 'undefined') {
            //escape dollar
            // console.log(x,item.series.xaxis.ticks[x].label);
            // content = content.replace(xPatternWithoutPrecision, item.series.xaxis.tickFormatter(x, item.series.xaxis).replace(/\$/g, '$$'));
            content = content.replace(xPatternWithoutPrecision, item.series.xaxis.ticks[x].label);
        }
        if (typeof item.series.yaxis.tickFormatter !== 'undefined') {
            //escape dollar
            content = content.replace(yPatternWithoutPrecision, item.series.yaxis.tickFormatter(y, item.series.yaxis).replace(/\$/g, '$$').replace('.0',''));
        }
