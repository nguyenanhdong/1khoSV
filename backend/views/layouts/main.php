...
<html lang="en">
    ...
    <body class="mod-bg-1 ">
                ...
                <div class="page-content-wrapper">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="<?= $user->fullname ?>">
                                            </span>
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="/site/logout">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <?php
                            ...
                            echo $this->render('partial/bread_crumb',['breadcrumbs'=>$breadcrumbs]);
        ...
        <nav class="shortcut-menu d-none d-sm-block">
            ...
            <a href="/site/logout" class="menu-item btn" data-toggle="tooltip" data-placement="left" title="Logout">
        ...
        <script src="/js/formplugins/bootstrap-daterangepicker/bootstrap-daterangepicker.js" type="text/javascript"></script> -->
                ...
                window.onload = function() {
                    if( $('.editor').length > 0 ){
                        tinymce.init({
                            ...
                            toolbar: 'undo redo | bold italic underline | fontselect fontsizeselect formatselect | image | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | forecolor backcolor | pagebreak | fullscreen preview print | insertfile media template link anchor codesample | ltr rtl',
                            toolbar_sticky: true,
                            fontsize_formats: "8px 9px 10px 11px 12px 13px 14px 16px 18px 20px 22px 24px 26px 28px 30px 32px 34px 36px 38px 40px 48px 72px",
                            image_advtab: true,
                            image_caption: true,
                            ...
                            tinycomments_author: '<?= Yii::$app->name ?>',
                            height : "510",
                            entity_encoding : "raw",
                            setup : function(ed) {
